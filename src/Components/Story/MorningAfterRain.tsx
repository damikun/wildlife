...
export default function MorningAfterRain(){
    ...
    return <>
        ...
        <div className="space-y-5 text-base lg:text-lg">
            ...
            <p>Vstávam ráno pred štvrtou a vravím si: <i className="italic font-semibold">"Nechce sa my"</i>. Trochu sa premáham, predsa som sa až tak dobre nevyspal. O polnoci som ešte počúval prichádzajúce búrku a hrmenie s ňou sprevádzané. Práve koly nočnej búrke, ktorá priniesla vodu po dlhotrvajúcom suchu, môže byt ranná scenéria sprevádzanou menšou hmlou a oparom, ktorý je skvelý ako jemne pozadie s peknou vlhkou dynamikou.</p>
            <p>Nechystám sa ďaleko, skôr na istotu, že nejakú vysokú uvidím.</p>
            <p>Vyrážam na miesto, kde už týždeň po večeroch monitorujem jeleniu zver a jej správanie v období sucha a vysokých denných teplôt.</p>
            <p>Len včera večer sa mi podarilo nafotiť pekne zábery priamo v kukuricom poli, neďaleko miesta kam práve kráčam.</p>
            <p>Je šero, svitať začína už o štvrtej, je obdobie najdlhšie dni.</p>
            ...
            <p>Hneď po vyslape kopca spomalím a spozorniem. Počujem aj vlastný buchot srdca. <i className="font-semibold">"Pomaly ďalej zájdeš"</i> a <i className="font-semibold">"Trpezlivosť ruže prináša"</i> je to, čo teraz platí. Nesmiem sa chovať akoby som tu bol len koly fotke. Ta možno bude odmenou, zato, ako sa v lese budem chovať.</p>
            <p>Za prvým medzi horizontom predo mnou ma byt posed. Nedávno som tam zazrel dvoch sestnastorakov päsť sa v repkovom poli... Hneď za posedom ústí na lúku zvierací chodník a už v minulo ti som tam pozoroval zver prechadzajucu z jedného lesa do druhého v skorých ranných hodinách.</p>
            ...
            <p>Samozrejme tvárim sa ako strom (haha)... Nezožral to, aj keď mám maskovanie... Skočil do lesa a začala pobrechavat... Nepáčilo sa mu to.  Momentálne je ich poľovná sezóna a akoby sa po nich zľahla zem. Vraví sa, že to vedia a <i>"Ahaho"</i> musí sa objaviť práve teraz. Nuž priestor  je to jeho a ja som tu ten nezelany hosť. Už nič nenarobím, nečakal som ho a evidentne ani on mňa.</p>
            ...
            <p>To, že nie vždy jelene reagujú na výstražné signály srnčie zvery (ako je brechot) už pozorujem opakovane a nijak konkrétne ma to neprekvapí. Opačne to, ale neplatí! Srnčia zver reaguje veľmi pozorne na jelenie výstražné signály. Práve, preto sa pri nich cíti bezpečne. Dalo sa, teda aj predpokladať, že nejaká ta srnčia v ich okolí bude.</p>
