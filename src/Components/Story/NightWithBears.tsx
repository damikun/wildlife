 ...
 export default function NightWithBears(){
    return <div className="space-y-5 text-base lg:text-lg">
        ...
        <div className="flex flex-col md:flex-row md:space-x-2 object-cover flex-nowrap overflow-hidden md:justify-between">
            <img className="rounded-sm shadow-sm h-96 xl:h-128 object-cover" src={GetUri("6ovefdgfnujfznk/46.webp")} alt="Posed kde nocujem"/>
        ...
        <p>Ako prvé vidím srnčiu. Ta, ale po chvíli hľadí do ľavá a uteká preč. Vravím si asi ide nejaký poľovník alebo niekto kto zablúdil? Už po minúte zisťujem, čo ich vyplašilo. Bol to maco Je po 9 večer slnko už zapadlo, a to je ich čas. Fotiť sa nedá tak nahrávam aspoň krátke video, aby som si to spätne vedel pripomenúť a zanalyzovať. Aj, keď bude zrnité, vôbec nevadí.</p>
        ...
        <p>Preistotu skontrolujem dvere a pokračujem v spaní.</p>
